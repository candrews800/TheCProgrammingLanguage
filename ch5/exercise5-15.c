 ...
 * case distinctions are not made during sorting; for example, a and
 * A compare equal.
 *
 */
...
int main(int argc, char *argv[])
{
    ...
    if ((nlines = readlines(lineptr, MAX_LINES)) >= 0) {
        mqsort((void **) lineptr, 0, nlines-1, (int (*)(void*,void*))(numeric ? numcmp : (fold ? fstrcmp : strcmp)), reverse);
